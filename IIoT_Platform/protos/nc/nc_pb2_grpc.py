...
from protos.nc import nc_pb2 as protos_dot_nc_dot_nc__pb2
...
class NetworkControllerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.HandleUplinkMetaData = channel.unary_unary(
        ...
        request_serializer=protos_dot_nc_dot_nc__pb2.HandleUplinkMetaDataRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
    self.HandleUplinkMACCommand = channel.unary_unary(
        '/nc.NetworkControllerService/HandleUplinkMACCommand',
        request_serializer=protos_dot_nc_dot_nc__pb2.HandleUplinkMACCommandRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
...
def add_NetworkControllerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'HandleUplinkMetaData': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protos_dot_nc_dot_nc__pb2.HandleUplinkMetaDataRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'HandleUplinkMACCommand': grpc.unary_unary_rpc_method_handler(
          servicer.HandleUplinkMACCommand,
          request_deserializer=protos_dot_nc_dot_nc__pb2.HandleUplinkMACCommandRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
  }
