...
_USERLISTITEM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='email', full_name='api.UserListItem.email', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='note', full_name='api.UserListItem.note', index=6,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='created_at', full_name='api.UserListItem.created_at', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updated_at', full_name='api.UserListItem.updated_at', index=8,
...
User = _reflection.GeneratedProtocolMessageType('User', (_message.Message,), dict(
  DESCRIPTOR = _USER,
  __module__ = 'protos.as.user_pb2'
  # @@protoc_insertion_point(class_scope:api.User)
  ))
_sym_db.RegisterMessage(User)

UserListItem = _reflection.GeneratedProtocolMessageType('UserListItem', (_message.Message,), dict(
...
UserOrganization = _reflection.GeneratedProtocolMessageType('UserOrganization', (_message.Message,), dict(
...
ListUserRequest = _reflection.GeneratedProtocolMessageType('ListUserRequest', (_message.Message,), dict(
...
ListUserResponse = _reflection.GeneratedProtocolMessageType('ListUserResponse', (_message.Message,), dict(
...
UpdateUserPasswordRequest = _reflection.GeneratedProtocolMessageType('UpdateUserPasswordRequest', (_message.Message,), dict(
...
_USERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\021\022\017/api/users/{id}'),
  ),
  _descriptor.MethodDescriptor(
    name='Create',
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\031\032\024/api/users/{user.id}:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Delete',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002\021*\017/api/users/{id}'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdatePassword',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002\"\032\035/api/users/{user_id}/password:\001*'),
  ),
])
