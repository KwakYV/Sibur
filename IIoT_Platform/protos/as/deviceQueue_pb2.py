...
# source: protos/as/deviceQueue.proto
...
DeviceQueueItem = _reflection.GeneratedProtocolMessageType('DeviceQueueItem', (_message.Message,), dict(
  ...
  __module__ = 'protos.as.deviceQueue_pb2'
