...
# source: protos/as/multicastGroup.proto
...
MulticastGroup = _reflection.GeneratedProtocolMessageType('MulticastGroup', (_message.Message,), dict(
  ...
  __module__ = 'protos.as.multicastGroup_pb2'
