...
# source: protos/as/gatewayProfile.proto
...
GatewayProfile = _reflection.GeneratedProtocolMessageType('GatewayProfile', (_message.Message,), dict(
  ...
  __module__ = 'protos.as.gatewayProfile_pb2'
