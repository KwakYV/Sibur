...
# source: protos/as/networkServer.proto
...
NetworkServer = _reflection.GeneratedProtocolMessageType('NetworkServer', (_message.Message,), dict(
  ...
  __module__ = 'protos.as.networkServer_pb2'
