...
# source: protos/ns/profiles.proto
...
ServiceProfile = _reflection.GeneratedProtocolMessageType('ServiceProfile', (_message.Message,), dict(
  ...
  __module__ = 'protos.ns.profiles_pb2'
...
RoutingProfile = _reflection.GeneratedProtocolMessageType('RoutingProfile', (_message.Message,), dict(
