...
# source: protos/aps/device.proto
...
_STREAMDEVICEFRAMELOGSRESPONSE.fields_by_name['uplink_frame'].message_type = protos_dot_aps_dot_common__pb2._UPLINKFRAMELOG
_STREAMDEVICEFRAMELOGSRESPONSE.fields_by_name['downlink_frame'].message_type = protos_dot_aps_dot_common__pb2._DOWNLINKFRAMELOG
...
Device = _reflection.GeneratedProtocolMessageType('Device', (_message.Message,), dict(
  DESCRIPTOR = _DEVICE,
  __module__ = 'protos.aps.device_pb2'
