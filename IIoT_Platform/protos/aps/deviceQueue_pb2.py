...
# source: protos/aps/deviceQueue.proto
...
DeviceQueueItem = _reflection.GeneratedProtocolMessageType('DeviceQueueItem', (_message.Message,), dict(
  ...
  __module__ = 'protos.aps.deviceQueue_pb2'
  # @@protoc_insertion_point(class_scope:api.DeviceQueueItem)
  ))
_sym_db.RegisterMessage(DeviceQueueItem)

EnqueueDeviceQueueItemRequest = _reflection.GeneratedProtocolMessageType('EnqueueDeviceQueueItemRequest', (_message.Message,), dict(
...
EnqueueDeviceQueueItemResponse = _reflection.GeneratedProtocolMessageType('EnqueueDeviceQueueItemResponse', (_message.Message,), dict(
...
FlushDeviceQueueRequest = _reflection.GeneratedProtocolMessageType('FlushDeviceQueueRequest', (_message.Message,), dict(
...
ListDeviceQueueItemsRequest = _reflection.GeneratedProtocolMessageType('ListDeviceQueueItemsRequest', (_message.Message,), dict(
...
ListDeviceQueueItemsResponse = _reflection.GeneratedProtocolMessageType('ListDeviceQueueItemsResponse', (_message.Message,), dict(
...
_DEVICEQUEUESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0023\"./api/devices/{device_queue_item.dev_eui}/queue:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Flush',
    ...
    serialized_options=_b('\202\323\344\223\002\036*\034/api/devices/{dev_eui}/queue'),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    ...
    serialized_options=_b('\202\323\344\223\002\036\022\034/api/devices/{dev_eui}/queue'),
  ),
])
