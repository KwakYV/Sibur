...
# source: protos/aps/profiles.proto
...
ServiceProfile = _reflection.GeneratedProtocolMessageType('ServiceProfile', (_message.Message,), dict(
  DESCRIPTOR = _SERVICEPROFILE,
  __module__ = 'protos.aps.profiles_pb2'
  # @@protoc_insertion_point(class_scope:api.ServiceProfile)
  ))
_sym_db.RegisterMessage(ServiceProfile)

DeviceProfile = _reflection.GeneratedProtocolMessageType('DeviceProfile', (_message.Message,), dict(
