...
# source: protos/aps/internal.proto
...
_PROFILERESPONSE.fields_by_name['user'].message_type = protos_dot_aps_dot_user__pb2._USER
...
ProfileSettings = _reflection.GeneratedProtocolMessageType('ProfileSettings', (_message.Message,), dict(
  ...
  __module__ = 'protos.aps.internal_pb2'
