...
# source: protos/aps/deviceProfile.proto
...
_CREATEDEVICEPROFILEREQUEST.fields_by_name['device_profile'].message_type = protos_dot_aps_dot_profiles__pb2._DEVICEPROFILE
_GETDEVICEPROFILERESPONSE.fields_by_name['device_profile'].message_type = protos_dot_aps_dot_profiles__pb2._DEVICEPROFILE
...
_UPDATEDEVICEPROFILEREQUEST.fields_by_name['device_profile'].message_type = protos_dot_aps_dot_profiles__pb2._DEVICEPROFILE
...
CreateDeviceProfileRequest = _reflection.GeneratedProtocolMessageType('CreateDeviceProfileRequest', (_message.Message,), dict(
  ...
  __module__ = 'protos.aps.deviceProfile_pb2'
...
DeviceProfileListItem = _reflection.GeneratedProtocolMessageType('DeviceProfileListItem', (_message.Message,), dict(
...
ListDeviceProfileRequest = _reflection.GeneratedProtocolMessageType('ListDeviceProfileRequest', (_message.Message,), dict(
...
ListDeviceProfileResponse = _reflection.GeneratedProtocolMessageType('ListDeviceProfileResponse', (_message.Message,), dict(
...
_DEVICEPROFILESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\031\"\024/api/device-profiles:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Get',
    ...
    serialized_options=_b('\202\323\344\223\002\033\022\031/api/device-profiles/{id}'),
  ),
  _descriptor.MethodDescriptor(
    name='Update',
    ...
    serialized_options=_b('\202\323\344\223\002-\032(/api/device-profiles/{device_profile.id}:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Delete',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002\033*\031/api/device-profiles/{id}'),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    ...
    serialized_options=_b('\202\323\344\223\002\026\022\024/api/device-profiles'),
  ),
])
