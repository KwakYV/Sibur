...
from protos.aps import as_pb2 as protos_dot_as_dot_as__pb2
...
class ApplicationServerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.HandleUplinkData = channel.unary_unary(
        '/aps.ApplicationServerService/HandleUplinkData',
    ...
    self.HandleProprietaryUplink = channel.unary_unary(
        '/aps.ApplicationServerService/HandleProprietaryUplink',
    ...
    self.HandleError = channel.unary_unary(
        '/aps.ApplicationServerService/HandleError',
    ...
    self.HandleDownlinkACK = channel.unary_unary(
        '/aps.ApplicationServerService/HandleDownlinkACK',
    ...
    self.SetDeviceStatus = channel.unary_unary(
        '/aps.ApplicationServerService/SetDeviceStatus',
    ...
    self.SetDeviceLocation = channel.unary_unary(
        '/aps.ApplicationServerService/SetDeviceLocation',
...
def add_ApplicationServerServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'aps.ApplicationServerService', rpc_method_handlers)
